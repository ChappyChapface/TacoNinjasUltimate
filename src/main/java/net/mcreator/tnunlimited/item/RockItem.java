...
import net.mcreator.tnunlimited.procedures.RockCooldownProcedure;
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					RockEntity entityarrow = RockEntity.shoot(world, entity, world.getRandom(), 0.4f, 4, 1);
					...
					RockCooldownProcedure.execute(entity, itemstack);
				}
