...
public abstract class Desert_RoachArmorItem extends ArmorItem {
	...
	public static class Helmet extends Desert_RoachArmorItem {
			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head",
									new ModelRoachHelmet(Minecraft.getInstance().getEntityModels().bakeLayer(ModelRoachHelmet.LAYER_LOCATION)).Head,
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "tnunlimited:textures/roachhelmet.png";
		}
	}
	...
	public static class Chestplate extends Desert_RoachArmorItem {
		...
		public void initializeClient(java.util.function.Consumer<net.minecraftforge.client.IItemRenderProperties> consumer) {
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("body",
									new ModelRoachChestplate(
											Minecraft.getInstance().getEntityModels().bakeLayer(ModelRoachChestplate.LAYER_LOCATION)).Body,
									"left_arm",
									new ModelRoachChestplate(
											Minecraft.getInstance().getEntityModels().bakeLayer(ModelRoachChestplate.LAYER_LOCATION)).LeftArm,
									"right_arm",
									new ModelRoachChestplate(
											Minecraft.getInstance().getEntityModels().bakeLayer(ModelRoachChestplate.LAYER_LOCATION)).RightArm,
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "tnunlimited:textures/roachchestplate.png";
		}
	}
