...
public class BulletProjectileItem extends Item {
	public BulletProjectileItem() {
		super(new Item.Properties().tab(null).durability(100));
		setRegistryName("bullet_projectile");
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BulletProjectileEntity entityarrow = BulletProjectileEntity.shoot(world, entity, world.getRandom(), 1f, 5, 0);
