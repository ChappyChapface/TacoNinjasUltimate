...
import net.mcreator.tnunlimited.procedures.PickaxeOfLuminescenceBlindingProcedure;
import net.mcreator.tnunlimited.procedures.CooldownWhenNotHeldInMainProcedure;

import java.util.List;

public class PickaxeOfLuminescenceItem extends PickaxeItem {
	public PickaxeOfLuminescenceItem() {
		super(new Tier() {
			public int getUses() {
				return 250;
			}
		...
		setRegistryName("pickaxe_of_luminescence");
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		PickaxeOfLuminescenceBlindingProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
