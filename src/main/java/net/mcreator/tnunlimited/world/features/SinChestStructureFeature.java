...
public class SinChestStructureFeature extends Feature<NoneFeatureConfiguration> {
	public static final SinChestStructureFeature FEATURE = (SinChestStructureFeature) new SinChestStructureFeature()
			.setRegistryName("tnunlimited:sin_chest_structure");
