...
public class NetherTowerLimitedFeature extends Feature<NoneFeatureConfiguration> {
	public static NetherTowerLimitedFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NetherTowerLimitedFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:nether_tower_limited", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:nether_tower_limited", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
