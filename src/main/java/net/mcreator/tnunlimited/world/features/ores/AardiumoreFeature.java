...
public class AardiumoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:aardiumore", FEATURE,
				new OreConfiguration(AardiumoreFeatureRuleTest.INSTANCE, TnunlimitedModBlocks.AARDIUMORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:aardiumore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(4), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(56)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class AardiumoreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<AardiumoreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<AardiumoreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("tnunlimited:aardiumore_match"), CUSTOM_MATCH);
		}
