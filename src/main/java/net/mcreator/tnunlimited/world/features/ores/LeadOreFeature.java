...
public class LeadOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:lead_ore", FEATURE,
				new OreConfiguration(LeadOreFeatureRuleTest.INSTANCE, TnunlimitedModBlocks.LEAD_ORE.get().defaultBlockState(), 5));
		PLACED_FEATURE = PlacementUtils.register("tnunlimited:lead_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(10), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(10), VerticalAnchor.absolute(30)), BiomeFilter.biome()));
		return FEATURE;
	}
	...
	private static class LeadOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("tnunlimited:lead_ore_match"), CUSTOM_MATCH);
		}
