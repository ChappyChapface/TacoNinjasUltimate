...
public class ZincOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:zinc_ore", FEATURE,
				new OreConfiguration(ZincOreFeatureRuleTest.INSTANCE, TnunlimitedModBlocks.ZINC_ORE.get().defaultBlockState(), 6));
	...
	private static class ZincOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<ZincOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<ZincOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("tnunlimited:zinc_ore_match"), CUSTOM_MATCH);
		}
