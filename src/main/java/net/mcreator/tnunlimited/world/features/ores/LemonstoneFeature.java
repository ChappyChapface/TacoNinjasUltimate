...
public class LemonstoneFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:lemonstone", FEATURE,
				new OreConfiguration(LemonstoneFeatureRuleTest.INSTANCE, TnunlimitedModBlocks.LEMONSTONE.get().defaultBlockState(), 16));
	...
	private static class LemonstoneFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<LemonstoneFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<LemonstoneFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("tnunlimited:lemonstone_match"), CUSTOM_MATCH);
		}
		...
		public boolean test(BlockState blockAt, Random random) {
			if (base_blocks == null) {
				base_blocks = List.of(Blocks.SAND, Blocks.SANDSTONE);
			}
