...
public class NubriumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("tnunlimited:nubrium_ore", FEATURE,
				new OreConfiguration(NubriumOreFeatureRuleTest.INSTANCE, TnunlimitedModBlocks.NUBRIUM_ORE.get().defaultBlockState(), 2));
	...
	private static class NubriumOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<NubriumOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<NubriumOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("tnunlimited:nubrium_ore_match"), CUSTOM_MATCH);
		}
