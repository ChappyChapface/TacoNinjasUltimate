...
import net.mcreator.tnunlimited.procedures.AccSet2Procedure;
...
public class AccessoriesMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AccessoriesMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TnunlimitedModMenus.ACCESSORIES, id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 142, 35) {
			@Override
			public boolean mayPickup(Player player) {
				return false;
			}
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 142, 17) {
			@Override
			public boolean mayPickup(Player player) {
				return false;
			}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof AccessoriesMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			AccSet2Procedure.execute(entity);
		}
	}
}
