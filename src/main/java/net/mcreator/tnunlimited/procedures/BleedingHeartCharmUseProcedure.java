...
public class BleedingHeartCharmUseProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof LivingEntity _entity)
			_entity.setHealth((float) Math.min(entity instanceof LivingEntity _livEnt ? _livEnt.getMaxHealth() : -1,
					(entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) + 7));
		if (!(new Object() {
