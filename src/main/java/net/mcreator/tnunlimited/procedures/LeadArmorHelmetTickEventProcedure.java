...
public class LeadArmorHelmetTickEventProcedure {
	public static void execute(Entity entity) {
		...
		if (TnunlimitedModItems.LEAD_ARMOR_BOOTS
				.get() == (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem()
