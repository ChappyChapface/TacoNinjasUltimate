...
import net.mcreator.tnunlimited.init.TnunlimitedModParticles;
	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getDouble("ammo") > 0) {
			...
			if (EnchantmentHelper.getItemEnchantmentLevel(TnunlimitedModEnchantments.KICKBACK, itemstack) >= 1) {
				n = (((-3) * (1 + 0.25 * EnchantmentHelper.getItemEnchantmentLevel(TnunlimitedModEnchantments.CALIBER, itemstack)))
			...
			if (!(new Object() {
				...
				if (num >= 0) {
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles(TnunlimitedModParticles.BULLET_SHELL, (entity.getX()), (entity.getY() + 1), (entity.getZ()), 6, 0.2, 0.2,
								0.2, 0.1);
				}
			} else if (new Object() {
				public boolean checkGamemode(Entity _ent) {
				...
				itemstack.getOrCreateTag().putDouble("ammo", 6);
				if (entity instanceof Player _player)
					_player.getCooldowns().addCooldown(itemstack.getItem(), 60);
				if (world instanceof ServerLevel _level)
					_level.sendParticles(TnunlimitedModParticles.BULLET_SHELL, (entity.getX()), (entity.getY() + 1), (entity.getZ()), 6, 0.2, 0.2,
