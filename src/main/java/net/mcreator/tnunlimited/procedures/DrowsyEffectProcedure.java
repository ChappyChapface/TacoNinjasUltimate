	...
	public static void execute(Entity entity) {
		...
		if (entity instanceof LivingEntity _entity)
			_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 10,
					entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(TnunlimitedModMobEffects.DROWSY)
							? _livEnt.getEffect(TnunlimitedModMobEffects.DROWSY).getAmplifier()
							: 0,
					(false), (false)));
		if (entity instanceof LivingEntity _entity)
