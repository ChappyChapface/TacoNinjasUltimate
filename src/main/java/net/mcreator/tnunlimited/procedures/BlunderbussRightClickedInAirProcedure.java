	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getDouble("ammo") > 0) {
			...
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(itemstack.getItem(), (int) (10
			...
			for (int index0 = 0; index0 < (int) (itemstack.getOrCreateTag().getDouble("ammo")); index0++) {
				if (entity instanceof LivingEntity _ent_sa && !_ent_sa.level.isClientSide()) {
					BuckshotPelletProjectileEntity.shoot(_ent_sa.level, _ent_sa, _ent_sa.level.getRandom(), 3,
							(float) (1.5 + 0.15 * EnchantmentHelper.getItemEnchantmentLevel(TnunlimitedModEnchantments.CALIBER.get(), itemstack)), 0);
				}
				{
					Entity _ent = entity;
