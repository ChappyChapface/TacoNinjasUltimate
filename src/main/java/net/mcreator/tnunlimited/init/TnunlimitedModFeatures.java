...
import net.mcreator.tnunlimited.world.features.AppleTreeFeature;
...
public class TnunlimitedModFeatures {
	...
	public static final RegistryObject<Feature<?>> APPLE_TREE = register("apple_tree", AppleTreeFeature::feature,
			new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES, AppleTreeFeature.GENERATE_BIOMES, AppleTreeFeature::placedFeature));
