...
public class AccessoriesScreen extends AbstractContainerScreen<AccessoriesMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("tnunlimited:textures/accessories.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "ACCESSORIES", 58, 7, -12829636);
		this.font.draw(poseStack, "", 71, 48, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 61, this.topPos + 25, 51, 20, new TextComponent("EQUIP"), e -> {
			if (true) {
