...
public class Modelender_protector<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tnunlimited", "modelender_protector"),
			"main");
	public final ModelPart bone;
	public final ModelPart Chestboi;
	public final ModelPart wing1;
	public final ModelPart wing2;
	public final ModelPart Head;
	public final ModelPart bb_main;

	public Modelender_protector(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chestboi = partdefinition.addOrReplaceChild("Chestboi",
				CubeListBuilder.create().texOffs(32, 70).addBox(-4.0F, -1.5F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition wing1 = partdefinition.addOrReplaceChild("wing1",
				CubeListBuilder.create().texOffs(23, 3).addBox(-1.0F, -1.5F, 0.2409F, 2.0F, 3.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
		...
		PartDefinition cube_r1 = wing1.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(72, 34).addBox(-1.1F, 0.5F, -1.5F, 2.0F, 21.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition wing2 = partdefinition.addOrReplaceChild("wing2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.5F, 0.2409F, 2.0F, 3.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(0.0F, 0.5F, -0.7591F, 0.0F, 17.0F, 36.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = wing2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(56, 70).addBox(-0.9F, 0.5F, -1.5F, 2.0F, 21.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 17.7409F, 1.0036F, 0.0F, 0.0F));
		PartDefinition Head = partdefinition.addOrReplaceChild(
				"Head", CubeListBuilder.create().texOffs(0, 70).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
						.texOffs(0, 86).addBox(-8.0F, -10.0F, -4.3F, 15.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -9.0F, -5.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild(
				"bb_main", CubeListBuilder.create().texOffs(68, 66).addBox(-7.0F, -33.0F, -7.0F, 3.0F, 30.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(65, 0).addBox(4.0F, -33.0F, -7.0F, 3.0F, 30.0F, 4.0F, new CubeDeformation(0.0F)),
