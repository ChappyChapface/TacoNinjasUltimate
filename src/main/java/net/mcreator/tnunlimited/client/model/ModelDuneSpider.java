...
public class ModelDuneSpider<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = RightLeg4
				.addOrReplaceChild(
						"cube_r1", CubeListBuilder.create().texOffs(25, 0).mirror()
								.addBox(-18.5F, -1.0F, -1.0F, 19.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r2 = RightLeg3
				.addOrReplaceChild(
						"cube_r2", CubeListBuilder.create().texOffs(25, 0).mirror()
								.addBox(-18.5F, -1.0F, -1.0F, 19.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r3 = RightLeg2
				.addOrReplaceChild(
						"cube_r3", CubeListBuilder.create().texOffs(25, 0).mirror()
								.addBox(-18.5F, -1.0F, -1.0F, 19.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.2182F, -0.4363F));
		...
		PartDefinition cube_r4 = RightLeg1
				.addOrReplaceChild(
						"cube_r4", CubeListBuilder.create().texOffs(25, 0).mirror()
								.addBox(-18.5F, -1.0F, -1.0F, 19.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, -0.5236F, -0.4887F));
		PartDefinition LeftLeg4 = partdefinition.addOrReplaceChild("LeftLeg4", CubeListBuilder.create(), PartPose.offset(3.0F, 16.0F, -1.0F));
		PartDefinition cube_r5 = LeftLeg4.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(25, 0).addBox(-0.5F, -1.0F, -1.0F, 19.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -5.1667F, -11.0F, 7.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.mirror().addBox(0.5F, -2.1667F, -13.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(0, 0)
						.addBox(-3.5F, -2.1667F, -13.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 15.1667F, 0.0F));
		PartDefinition Abdomen = partdefinition.addOrReplaceChild("Abdomen",
				CubeListBuilder.create().texOffs(0, 18).addBox(-7.0F, -7.5F, 0.0F, 14.0F, 11.0F, 20.0F, new CubeDeformation(0.0F)),
