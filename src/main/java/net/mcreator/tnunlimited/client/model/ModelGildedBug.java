...
public class ModelGildedBug<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(14, 5).mirror().addBox(1.5F, -3.5F, -5.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(14, 5).addBox(-1.5F, -3.5F, -5.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 10)
						.addBox(-1.5F, -1.5F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, 21.5F, -3.0F));
		...
		PartDefinition MidLeftLeg = partdefinition.addOrReplaceChild("MidLeftLeg",
				CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition MidrightLeg = partdefinition.addOrReplaceChild("MidrightLeg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.5F, 22.0F, -0.5F));
		PartDefinition BackRightLeg = partdefinition.addOrReplaceChild("BackRightLeg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.5F, 22.0F, 1.5F));
		PartDefinition bb_main = partdefinition
				.addOrReplaceChild(
						"bb_main", CubeListBuilder.create().texOffs(0, 16).addBox(-3.0F, -5.0F, -3.0F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(-3.0F, -6.0F, 2.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
