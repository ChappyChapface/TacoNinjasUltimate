...
public class ModelCaptainHat<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tnunlimited", "model_captain_hat"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -9.0F, -4.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(20, 11).addBox(-3.0F, -2.0F, 0.5F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -8.0F, 3.5F, 0.0F, -0.4363F, 0.0F));
		PartDefinition cube_r2 = bb_main
				.addOrReplaceChild(
						"cube_r2", CubeListBuilder.create().texOffs(20, 11).mirror()
								.addBox(0.0F, -2.0F, 0.5F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(3.0F, -8.0F, 3.5F, 0.0F, 0.4363F, 0.0F));
		PartDefinition cube_r3 = bb_main
				.addOrReplaceChild(
						"cube_r3", CubeListBuilder.create().texOffs(0, 24).mirror()
								.addBox(0.0F, -2.0F, -1.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
						PartPose.offsetAndRotation(3.0F, -8.0F, -3.5F, 0.0F, -0.4363F, 0.0F));
		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 24).addBox(-4.0F, -2.0F, -1.5F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -8.0F, -3.5F, 0.0F, 0.4363F, 0.0F));
