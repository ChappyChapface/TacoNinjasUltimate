...
public class ModelRoachChestplate<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("tnunlimited", "model_roach_chestplate"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(24, 0).mirror().addBox(-3.5F, -2.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(19, 0).addBox(-4.5F, -3.0F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.0F, 13.5F, -0.5F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(24, 0).addBox(-1.5F, -2.0F, -3.0F, 5.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(19, 0)
						.mirror().addBox(1.5F, -3.0F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(7.0F, 13.5F, -0.5F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(1, 27).addBox(-4.5F, 6.8F, -2.0F, 9.0F, 3.0F, 4.0F, new CubeDeformation(0.6F)).texOffs(1, 27)
