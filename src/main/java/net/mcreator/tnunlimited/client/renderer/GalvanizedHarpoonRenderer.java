...
public class GalvanizedHarpoonRenderer extends EntityRenderer<GalvanizedHarpoonEntity> {
	private static final ResourceLocation texture = new ResourceLocation("tnunlimited:textures/galvanizedharpoon.png");
	...
	@Override
	public void render(GalvanizedHarpoonEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
