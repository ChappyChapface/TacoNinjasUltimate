...
public class RockEntity extends AbstractArrow implements ItemSupplier {
	public RockEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		super(TnunlimitedModEntities.ROCK, world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(TnunlimitedModItems.ROCK);
	}
	...
	public void tick() {
		...
		if (this.inGround) {
			...
			RockParticlesProcedure.execute(world, x, y, z);
			this.discard();
		}
	}

	public static RockEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		RockEntity entityarrow = new RockEntity(TnunlimitedModEntities.ROCK, entity, world);
	...
	public static RockEntity shoot(LivingEntity entity, LivingEntity target) {
		RockEntity entityarrow = new RockEntity(TnunlimitedModEntities.ROCK, entity, entity.level);
