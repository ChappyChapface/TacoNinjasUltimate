...
import net.mcreator.tnunlimited.procedures.RockParticlesProcedure;
...
public class RockEntity extends AbstractArrow implements ItemSupplier {
	public RockEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TnunlimitedModEntities.ROCK.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(TnunlimitedModItems.ROCK.get());
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		RockParticlesProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(),
	...
	public static RockEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		RockEntity entityarrow = new RockEntity(TnunlimitedModEntities.ROCK.get(), entity, world);
	...
	public static RockEntity shoot(LivingEntity entity, LivingEntity target) {
		RockEntity entityarrow = new RockEntity(TnunlimitedModEntities.ROCK.get(), entity, entity.level);
