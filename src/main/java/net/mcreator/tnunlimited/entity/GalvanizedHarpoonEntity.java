...
public class GalvanizedHarpoonEntity extends AbstractArrow implements ItemSupplier {
	public GalvanizedHarpoonEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TnunlimitedModEntities.GALVANIZED_HARPOON.get(), world);
	}
	...
	public static GalvanizedHarpoonEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		GalvanizedHarpoonEntity entityarrow = new GalvanizedHarpoonEntity(TnunlimitedModEntities.GALVANIZED_HARPOON.get(), entity, world);
	...
	public static GalvanizedHarpoonEntity shoot(LivingEntity entity, LivingEntity target) {
		GalvanizedHarpoonEntity entityarrow = new GalvanizedHarpoonEntity(TnunlimitedModEntities.GALVANIZED_HARPOON.get(), entity, entity.level);
