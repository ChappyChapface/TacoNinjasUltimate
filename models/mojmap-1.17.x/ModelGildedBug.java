...
public class ModelGildedBug<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gildedbug"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(14, 5).mirror()
						.addBox(1.5F, -3.5F, -5.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(14, 5).addBox(-1.5F, -3.5F, -5.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(0, 10).addBox(-1.5F, -1.5F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-3.0F, -5.0F, -3.0F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
